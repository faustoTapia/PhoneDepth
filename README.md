...
### PhoneDepth
Download dataset available in [PhoneDepth](https://1drv.ms/u/s!AtG9ZoXQaQn7nK1boSzYJ7A4elwrgQ?e=XvwRfL). Extract it and place the `PhoneDepth` data-lists in the root directory of the dataset. You want to have a file structure as follows:
